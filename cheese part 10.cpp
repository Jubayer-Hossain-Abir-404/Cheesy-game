...
public:
    void get_cheese(string s[],int n)
    {
        ...
        else
        {
            if(dj==1)
            {
                cout<< endl<<"Sadly "<<s[bc1]<< " could not reach the cheese"<<endl;
            }
            else if(dj==2)
            {
                cout<<endl<<"Sadly "<<s[bc1]<< " and "<<s[bc2]<< " could not reach the cheese"<<endl;
            }
            else if(dj==3)
            {
                cout<<endl<<"Sadly "<<s[bc1]<< ","<<s[bc2]<< ","<<s[bc3]<< " could not reach the cheese"<<endl;
            }
        }
    }
