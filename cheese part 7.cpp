...
class cheese
{
    ...
    int p1,p2,p3,p4,p5,j5[100],saitama,saitama1=0;
public:
    void get_cheese(string s[],int n)
    {
        ...
        for(i=1; i<=n; i++)
        {
            ...
            if(i==1&&m1==2)
            {
                ...
                if(c1==1)
                {
                    cout<< " is the first of all as he won the game in first attempt"<<endl;
                    saitama++;
                }
                else
                {
                    cout<< " are the first of all a they won the game in the first place"<<endl;
                    saitama1+=j;
                }
            }
            if(i==2&&m2==2)
            {
                ...
                if(c2==1&&saitama==0&&saitama1==0)
                {
                    cout<< " is the first of all and he won the game in second attempt"<<endl;
                    saitama++;
                }
                if(c2==1&&saitama==1)
                {
                    cout<< " is the second of all and he won the game in the second position"<<endl;
                }
                if(c2==1&&saitama1>1)
                {
                    int result=saitama1-5;
                    if(result==0)
                    {
                        cout<< "Astonishing!!!Everyone has won the game in the first attempt"<<endl;
                    }
                    else
                    {
                        cout<< " is at no."<<saitama1-1<< " position"<<endl;
                    }
                }
                if(saitama==0&&saitama1!=0)
                {
                    cout<< " are the first of all as they won the game in the first place"<<endl;
                    saitama1+=j;
                }
                if(saitama1>1)
                {
                    cout<< " are in no."<<saiatama1<< " position"<<endl;
                }
            }
            if(i==3&&m3==2)
            {
