    ...
    void get_cheese(string s[],int n)
    {
        ...
        for(i=1; i<=n; i++)
        {
            ...
            for(k=1; k<=4; k++)
            {
                ...
                {
                    cout<<s[k]<< " Please jump by pressing key 'j':";
                    cin>>ch;
                    if(ch=='j')
                    {
                        number=1+rand()%10;
                        ...
                        if(number<data[k]||number>data[k])
                        {
                            ...
                            else if(number>data[k])
                            {
                                ...
                                cout<< "                    *   *        *    *"<<endl;
                                cout<< "                       *              *"<<endl;
                                for(int offo=0; offo<number-data[k]; offo++)
                                {
                                    cout<<endl;
                                }
                                cout<<endl;
        ...
        else
        {
            if(dj==1)
            {
                cout<< endl<<"Sadly "<<s[bc1]<< " could not catch the cheese"<<endl;
            }
            else if(dj==2)
            {
                cout<<endl<<"Sadly "<<s[bc1]<< " and "<<s[bc2]<< " could not catch the cheese"<<endl;
            }
            else if(dj==3)
            {
                cout<<endl<<"Sadly "<<s[bc1]<< ","<<s[bc2]<< ","<<s[bc3]<< " could not catch the cheese"<<endl;
            }
        }
    }
...
int main()
{
    cheese c1;
    string str1[100];
    cout<< "                       -_- -_- -_-Welcome to a very cheesy world -_- -_- -_-"<<endl<<endl<<endl<<endl<<endl<<endl;
    for(int i=1; i<=4; i++)
    {
